...
#Grab write values
con_old, con_new = utils.grab_DB_data(file_struct.DBname,'Scards',file_struct.SCTable_CondOverwrite)
rs_old, rs_new = utils.grab_DB_data(file_struct.DBname,'Scards',file_struct.SCTable_RSOverwrite)
