...
request_cpus = cores_req_scard
request_memory = mem_req_scard GB
...
transfer_input_files=runscript.sh,condor_wrapper, scard_name
transfer_output_files = out_$(Cluster)_nnevents_scard
